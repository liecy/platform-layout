...
public class CustomAdapter extends ArrayAdapter<com.example.platformlayout.Konten>{

    private int layout;
    private Context mContext;
    private List<Konten> konten;

    public CustomAdapter (@NonNull Context context, int resource, List<com.example.platformlayout.Konten> object){
